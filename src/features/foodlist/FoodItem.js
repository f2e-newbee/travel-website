    ...
    return (
        ...
        <section className="lg:px-20  sm:px-16 px-8  lg:py-28  py-24 bg-secondary-light">
            <div className="lg:flex block justify-center container max-w-screen-xl mx-auto">
                <div>
                    <div className="mx-auto lg:w-96 lg:h-96 w-full h-80 rounded" style={data && bgImg}></div>
                </div>
                <div className="lg:ml-20 ml-0 lg:mt-0 mt-20 w-full">
                    <div className="lg:p-16 p-8 lg:min-h-400  h-auto border-8 border-secondary 
                    flex items-center text-primary-dark leading-8  
                    lg:text-xl text-md
                    text-center font-bold">
                        <p>{data.Description ? data.Description : data.DescriptionDetail}</p>
                    </div>
                </div>
            </div>
        </section>
